...
class WorkerBridge(worker_interface.WorkerBridge):
    ...
    def preprocess_request(self, user):
        ...
        return pubkey_hash, pubkey_hash_version, desired_share_target, desired_pseudoshare_target
    ...
    def get_work(self, pubkey_hash, pubkey_hash_version, desired_share_target, desired_pseudoshare_target, worker_ip=None):
